...
class PDTransformerDecoder(MyConditionalDetrTransformerDecoder):
...
class PartDecoder(BaseModule):
    ...
    def _init_layers(self) -> None:
        ...
        self.decoder = PDTransformerDecoder(**self.decoder)
...
class FARE(BaseModule):
    ...
    def forward(self,x):    
        ...
        out,pos_attn_score_layers = self.PartDecoder(out) # out{'hidden_states'[num_layers,batch,num_queries+1,dim],'references'[1,batch,2]}
