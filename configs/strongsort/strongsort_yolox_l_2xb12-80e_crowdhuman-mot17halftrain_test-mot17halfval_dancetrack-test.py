_base_ = [
    './yolox_l_2xb16-80e_crowdhuman-mot17halftrain_test-mot17halfval_amp.py',  # noqa: E501
]
...
model = dict(
    ...
    reid=dict(
        ...
        head=dict(
            ...
            fc_channels=1024,
            out_channels=128,
            num_classes=380,            ### 如何确定？？ MOT17中行人个数
...
val_evaluator = dict(
    ...
    postprocess_tracklet_cfg=[
        dict(
            ...
            min_num_frames=5,       # 5
            max_num_frames=20,      # 20
            use_gsi=True,
            smooth_tau=10)
    ])
test_evaluator = val_evaluator

default_hooks = dict(logger=dict(type='LoggerHook', interval=1),checkpoint=dict(save_best='auto'))
