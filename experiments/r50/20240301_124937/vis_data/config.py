...
default_hooks = dict(
    checkpoint=dict(
        by_epoch=False, interval=2000, save_best='auto',
        type='CheckpointHook'),
...
train_cfg = dict(max_iters=140000, type='IterBasedTrainLoop', val_interval=500)
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        triplet_sampler=dict(ins_per_id=4, num_ids=64),
        type='ReIDDataset'),
    num_workers=2,
    persistent_workers=True,
